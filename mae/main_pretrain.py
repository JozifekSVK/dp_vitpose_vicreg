...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/content/drive/MyDrive/DP_pose_estimation/experiments_MAE/',
...
def main(args):
    ...
    dataset_train = CocoDetection( str(args.data_path) + '/train2017/', str(args.data_path) + '/annotations/person_keypoints_train2017.json', transform = transform_train )
    print(dataset_train)
